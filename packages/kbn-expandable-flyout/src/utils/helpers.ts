...
export const openFlyout = (
  ...
  const { scope, left, right, preview } = payload;
 ...
 */
export const openFlyoutRightPanel = (
  state: FlyoutState,
  payload: { scope: string; panel: FlyoutPanel }
): FlyoutState => {
  const { scope, panel } = payload;
 ...
 */
export const openFlyoutLeftPanel = (
  state: FlyoutState,
  payload: { scope: string; panel: FlyoutPanel }
): FlyoutState => {
  const { scope, panel } = payload;
 ...
 */
export const openFlyoutPreviewPanel = (
  state: FlyoutState,
  payload: { scope: string; panel: FlyoutPanel }
): FlyoutState => {
  const { scope, panel } = payload;
 ...
 */
export const closeFlyoutRightPanel = (
  state: FlyoutState,
 ...
 */
export const closeFlyoutLeftPanel = (
  state: FlyoutState,
  payload: { scope: string }
): FlyoutState => {
  const { scope } = payload;
 ...
 */
export const closeFlyoutPreviewPanel = (
  state: FlyoutState,
  payload: { scope: string }
): FlyoutState => {
  const { scope } = payload;
 ...
 */
export const previousFlyoutPreviewPanel = (
  state: FlyoutState,
  payload: { scope: string }
): FlyoutState => {
  const { scope } = payload;
 ...
 */
export const closeFlyout = (state: FlyoutState, payload: { scope: string }): FlyoutState => {
  const { scope } = payload;
